    ...
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlnsXlink="http://www.w3.org/1999/xlink" xmlnsSvgjs="http://svgjs.dev/svgjs" viewBox="0 0 800 800">
      <defs>
        <radialGradient id="ccclaymoji-grad-dark" r="93%" cx="20%" cy="20%">
          <stop offset="70%" stopColor="hsl(50, 98%, 50%)" stopOpacity="0"></stop>
        ...
        <radialGradient id="ccclaymoji-grad-light" r="65%" cx="28%" cy="20%">
          ...
          <stop offset="100%" stopColor="hsl(50, 98%, 50%)" stopOpacity="0"></stop>
        </radialGradient>
      ...
      <g strokeLinecap="round" transform="rotate(23, 400, 400)">
        ...
        <path d="M350 512.5Q400 562.5 450 512.5 " strokeWidth="21" stroke="hsl(3, 100%, 51%)" fill="none" filter="url(#mouth-shadow)"></path>
        <path d="M350 512.5Q400 562.5 450 512.5 " strokeWidth="7" stroke="url(#mouth-light)" fill="none" filter="url(#inner-blur)"></path>
      </g>
    </svg>
  );
};
